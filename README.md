...
2. Sign-up is invite-only via an email allowlist. Because any signed-in family member can
   read the house's gate and wifi codes, **who can sign up _is_ the security boundary**.
